// gen.js
// Script to generate initial project files for a high-performance JS CLI tool
...
`,
  'ast.js': `import { transformSync, parseSync, printSync } from '@swc/core';
import fs from 'fs';
...
`,
  'olama.js': `import axios from 'axios';
...
`,
  'key.js': `import dotenv from 'dotenv';
dotenv.config();
...
`,
  '.env.example': `# OLAMA API Key
OLAMA_API_KEY=your_key_here
`,
  'README.md': `# olama-ast-cli
