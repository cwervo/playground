...
set res [::printable::pageframe::encode \
...
set tres [::printable::pageframe::encode -source "puts hi\n" -out $tinyframe \
    -pagewmm 140 -pagehmm 100 -cellmm 2.0 -bandmm 26 -quietmm 6 -dpi 120 \
...
set d [::printable::pageframe::decode $frame]
...
set d [::printable::pageframe::decode $shot]
...
set d [::printable::pageframe::decode $shot2]
...
set d [::printable::pageframe::decode $scan]
...
set res [::printable::pageframe::encode -source $big -out $bframe \
    -pagewmm 140 -pagehmm 100 -cellmm 2.0 -bandmm 26 -quietmm 6 -dpi 120 \
    -host testhost -ip 10.0.0.42 -id 8]
check "encoder flags incomplete" [expr {![dict get $res complete]}]
set d [::printable::pageframe::decode $bframe]
...
set res [::printable::pageframe::encode -source $big -out $mbig \
    -cellmm 2.0 -quietmm 6 -dpi 120 -maxbandmm 26 \
    -host testhost -ip 10.0.0.42 -id 11]
set d [::printable::pageframe::decode $mbig]
