# Tcl script to generate the Bluesky Quick List Adder Chrome extension files.
# To run: tclsh gen_extension.tcl

# --- Procedure to create a file with given content ---
proc createFile {dir filename content} {
...
{
  "manifest_version": 3,
  "name": "Bluesky Quick List Adder",
  "version": "1.1",
  "description": "Adds a button to a user's profile menu to add them to a brand new list, skipping several steps.",
  "content_scripts": [
    {
      "matches": ["https://bsky.app/profile/*"],
      "js": ["content.js"]
    }
  ],
  "host_permissions": [
...
set outputDir "bluesky-quick-list"
puts "Generating extension files in directory: $outputDir"
...
# Create the files
createFile $outputDir "manifest.json" $manifestContent
createFile $outputDir "content.js" $contentJsContent

puts "\nDone. To install the extension in Chrome:"
puts "1. Open Chrome and go to chrome://extensions"
puts "2. Enable 'Developer mode' in the top right."
puts "3. Click 'Load unpacked'."
puts "4. Select the '$outputDir' directory."
